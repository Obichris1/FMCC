    ...
    <div className="font-sans">
      ...
      >
        ...
        <motion.div className="relative z-10 p-4" variants={slideInFromBottom}>
          ...
          <Typography className="!text-sm md:!text-xl text-gray-200 !max-w-2xl">With in-depth knowledge and a diverse operational reach, we deliver comprehensive and reliable solutions across industries..</Typography>
        </motion.div>
      </motion.div>
