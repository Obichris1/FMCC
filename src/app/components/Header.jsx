              ...
              <AnimatePresence>
                {isservicesOpen && (
                  <motion.div
                    ...
                    className="absolute left-1/2 top-10 -translate-x-1/2 w-[40vw] xl:w-[50vw] bg-white text-black shadow-xl z-50 py-8 px-4 pr-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
                  >
